...
from src.repositories.repo_catch.repository import RepoCatch
from src.domain.catch.catch_model import Catch
from src.services.service_api.service import PokeApiService
